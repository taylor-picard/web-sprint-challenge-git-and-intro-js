...
console.log('1.1:', artists[0].name);

//(2) Bio of the third artist (2nd index) in the array 

console.log('1.2:', artists[2].bio);
...
console.log('3:', getArtistByIndex(artists, 0));
...
console.log('4:',listOfNames(artists));
...
function removeArtist(array, number) {
  let newArray5 = [...array];
  newArray5.splice(number, 1);
  return newArray5
}

console.log('5:', removeArtist(artists, 0))
...
function addArtist(array, name, years, genre, nationality, bio) {
  ...
  newArray6.push(newObj);
  return newArray6;
}

console.log('6:', addArtist(artists, 'Taylor', '1998-2023', 'Web Development', 'American', 'I love to travel. Looking forward to learning more.'));
...
function lotsOfArt(array) {
  ...
  for(let i = 0; i < array.length; i++){
    if(array[i].paintings > 100){
      newArray7.push(array[i].name);
    }
  }
  return newArray7;
}
console.log('7:', lotsOfArt(artists));
